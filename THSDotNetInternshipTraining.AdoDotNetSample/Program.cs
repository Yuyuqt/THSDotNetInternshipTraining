    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                //dont let user type non numeric value
                ...
                switch (option)
                {
                    ...
                    case 3:
                        ...
                        {
                            Student student = adoService.Edit(editId);
                            if (student != null)
                            {
                    ...
                    case 4:
                        ...
                        // We call Edit to pull current info before doing the database Update
                        Student targetStudent = adoService.Edit(updateId);
                        ...
                        adoService.Update(targetStudent);
                        break;
